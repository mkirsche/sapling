...
runtimeNames = ['Bowtie', 'Mummer', 'Sapling (.01% overhead)', 'Sapling (1% overhead)', 'Sapling (25% overhead)']
...
sns.lineplot(qlengths, sapling01Runtimes, marker = "o", color = pal[2])
sns.lineplot(qlengths, sapling1Runtimes, marker = "o", color = pal[3])
sns.lineplot(qlengths, sapling25Runtimes, marker = "o", color = pal[4])
plt.ylim(-20, 1390)
